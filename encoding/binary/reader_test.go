...
func TestBinaryReaderSimple(t *testing.T) {
	...
	if err := sb.Write(b, sb.LittleEndian, t1); err != nil {
		t.Fatal(err)
	}
	br := BinaryReader{Reader: bytes.NewReader(b.Bytes()), Endianess: sb.LittleEndian}
...
func TestBinaryReaderAlign(t *testing.T) {
	...
	if err := sb.Write(b, sb.LittleEndian, t1.A); err != nil {
		t.Fatal(err)
	}
	if err := sb.Write(b, sb.LittleEndian, t1.B); err != nil {
		t.Fatal(err)
	}
	if err := sb.Write(b, sb.LittleEndian, t1.C); err != nil {
		t.Fatal(err)
	}
	if err := b.WriteByte('\u0000'); err != nil {
		t.Fatal(err)
	}
	if err := sb.Write(b, sb.LittleEndian, t1.D); err != nil {
		t.Fatal(err)
	}
...
func TestBinaryReaderAlign2(t *testing.T) {
	...
	if err := sb.Write(b, sb.LittleEndian, []uint32{1, 2, 3, 4}); err != nil {
		t.Fatal(err)
	}
	br := BinaryReader{Reader: bytes.NewReader(b.Bytes()), Endianess: sb.LittleEndian}
...
func TestBinaryReaderStringLength(t *testing.T) {
	...
	if err := sb.Write(b, sb.LittleEndian, t1.Length); err != nil {
		t.Fatal(err)
	}
...
func TestBinaryReaderComplex(t *testing.T) {
	...
	if err := sb.Write(b, sb.LittleEndian, t1.Count); err != nil {
		t.Fatal(err)
	}
...
func TestBinaryReaderIf(t *testing.T) {
	...
	for _, test := range tests {
		b := bytes.NewBuffer(nil)
		t1.Magic = test
		if err := sb.Write(b, sb.LittleEndian, t1.Magic); err != nil {
			t.Fatal(err)
		}
		if t1.Magic == 1 {
			if err := sb.Write(b, sb.LittleEndian, t1.A); err != nil {
